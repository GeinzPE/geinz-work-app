...
class compras_productos_vendedor : AppCompatActivity() {
    ...
    private fun obtnerDatosProducto(idProducto: String,idTrabajador: String) {
        ...
        db.get().addOnSuccessListener { res ->
            if (res.exists()) {
                Log.d("FirestoreResponse", "Datos obtenidos: ${res.data}")  // 🔍 Ver qué trae la base de datos
                ...
                Log.d("DatosProducto", "Categoría: $categoria, Marca: $marca, Modelo: $modelo, Stock: $stok, Garantía: $garantia")
                ...
                binding.precioproducto.textoNumero2.text = precio.toString()
            } else {
