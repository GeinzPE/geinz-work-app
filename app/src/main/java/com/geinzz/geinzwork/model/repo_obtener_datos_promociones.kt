...
class repo_obtener_datos_promociones {
    ...
    suspend fun obtner_datos_promocion(
        ...
        // 🔹 whatsapp
        val metodo_contacto = datos["metodo_contacto"] as? Map<String, Any>
        val wsap_numero = metodo_contacto?.get("whatsapp") as? Map<String, Any>
        val numero_contacto = wsap_numero?.get("numero") as? String ?: ""
        ...
        return promociones_tiendas_negocios(
            ...
            numero_contacto_teinda = numero_contacto,img_logo_tienda=logo_tienda
        )
    }
