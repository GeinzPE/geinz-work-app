...
data class dataclass_seguridad(
    ...
    val numero_llamada: List<String> = emptyList(),
    val numero_whatsapp: List<String> = emptyList(),
    val latidud: Double = 0.0,
    val longitud: Double = 0.0,
    val referencia: String = "",
    val img_ref: String = "",
    val categoria: String = "",
    val etiqutas_emergencias: List<String> = emptyList(),
    val etiquetas_no_urgente: List<String> = emptyList(),
