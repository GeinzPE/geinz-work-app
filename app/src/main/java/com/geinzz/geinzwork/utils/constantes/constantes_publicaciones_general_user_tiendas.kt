...
import com.geinzz.geinzwork.ui.adapters.adapterInicializarRecycleimgProductosTrabajadores
import com.geinzz.geinzwork.ui.adapters.adapter_mostra_articulos_trabajadores
...
import com.geinzz.geinzwork.fragmentos.productosPublicadosVista.compras_productos_vendedor
import com.geinzz.geinzwork.fragmentos.productosPublicadosVista.ver_mas_productos_publicados_trabajadores
            ...
            if (res.exists()) {
                ...
                if (img_url.isNotEmpty()) {
                    Firebase.dynamicLinks.shortLinkAsync {
                        link = Uri.parse("https://geinzapp.page.link/?idTrabajadorVeriProducto=$idTrabajador&idProducto=$id_publicacion")
    ...
    fun crear_dinamick_link_prblicaciones_trabajador(
        ...
        userCollections.get().addOnSuccessListener { res ->
            if (res.exists()) {
                ...
                Firebase.dynamicLinks.shortLinkAsync {
                    link = Uri.parse("https://geinzapp.page.link/?idTrabajadorVeri=${idTrabajador}&idpublicacion=${id_publicacion}")
                    domainUriPrefix = "https://geinzapp.page.link"
                    androidParameters("com.geinzz.geinzwork") {
                        minimumVersion = 125
                    }
