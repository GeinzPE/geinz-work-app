...
public final class FragmentReviewBinding implements ViewBinding {
  ...
  private FragmentReviewBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull Chip todos, @NonNull Chip tuReview, @NonNull Chip unoATres) {
  ...
  public static FragmentReviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tu_review;
      Chip tuReview = ViewBindings.findChildViewById(rootView, id);
      if (tuReview == null) {
        break missingId;
      }
      ...
      return new FragmentReviewBinding((RelativeLayout) rootView, binding_IncudeProgrs, SinReview,
          ...
          reyclerviewReview, swipe, todos, tuReview, unoATres);
    }
