...
public final class FragmentInicioFracmentBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textoDestacado;

  @NonNull
  public final TextView tituloDestacado;
  ...
  @NonNull
  public final TextView verificadoBoolean;
  ...
  private FragmentInicioFracmentBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull SwipeRefreshLayout swipe, @NonNull TextView textoDestacado,
      @NonNull TextView tituloDestacado, @NonNull TextView verProductos,
      ...
      @NonNull TextView verdesarrollo, @NonNull TextView verificadoBoolean,
    ...
    this.tituloDestacado = tituloDestacado;
    ...
    this.verificadoBoolean = verificadoBoolean;
  ...
  public static FragmentInicioFracmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.texto_destacado;
      TextView textoDestacado = ViewBindings.findChildViewById(rootView, id);
      if (textoDestacado == null) {
        break missingId;
      }

      id = R.id.titulo_destacado;
      TextView tituloDestacado = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.verificadoBoolean;
      TextView verificadoBoolean = ViewBindings.findChildViewById(rootView, id);
      if (verificadoBoolean == null) {
        break missingId;
      }
      ...
      return new FragmentInicioFracmentBinding((FrameLayout) rootView,
          ...
          swipe, textoDestacado, tituloDestacado, verProductos, verTecnicos, verTiendas,
          verTrabajohogar, verTrabajosPublicados, verdesarrollo, verificadoBoolean, vermecanica,
          vertrasnporte);
    }
