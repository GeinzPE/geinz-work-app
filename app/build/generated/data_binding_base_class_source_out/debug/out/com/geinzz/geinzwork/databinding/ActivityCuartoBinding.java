...
public final class ActivityCuartoBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCuartoBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityCuartoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCuartoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_cuarto, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCuartoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCuartoBinding((ConstraintLayout) rootView, SguienteCuenta, creaDiseA,
